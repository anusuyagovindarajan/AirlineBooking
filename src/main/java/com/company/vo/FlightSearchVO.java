...
import com.company.service.PricingService;
...
public class FlightSearchVO {
    ...
    public double getSurgePrice(FlightSearchVO flightSearchVO,FlightVO flightVO) {
        PricingService pricingService = new PricingService();
        return pricingService.surgePrice(flightSearchVO,flightVO);
    }
